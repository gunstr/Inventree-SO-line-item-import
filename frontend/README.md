# SO Line Item Import- Frontend Code

This directory contains the frontend code for the SO Line Item Import plugin.
...
This will compile the frontend into the `../so_line_item_import/static` directory (ready for distribution).
